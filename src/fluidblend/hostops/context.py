"""Execution context shared by the host operations."""
...
from fluidblend.contracts.operations import OperationRequest, StrictModel
...
class HostContext:
    ...
    def result(
        self, status: OperationStatus = OperationStatus.succeeded, errors: list[ErrorRecord] | None = None
    ) -> OperationResult:
