...
repository) and [docs/roadmap.md](docs/roadmap.md). Status on 17 September 2026: version 0.5.1 (P0, live, lots 3 and 4: every P1 scenario passes; P1 refinement; web game target).
