...
| fluidblend runtime add-on | 0.6.0 (`bl_info` 0, 6, 0) | installed in the Blender 5.2 user add-ons directory and enabled headlessly; operators `fluidblend.identity`, `start_request`, `open_file` exercised by L01–L09, Director operators by B06 |
